...
type ListComponentProps<D = unknown> = {
  ...
  suggestionHandlers: {
    onMouseDown: (id: SuggestionId) => void;
    onMouseOver: (id: SuggestionId) => void;
  };
};
...
type SuggestionListArgs<D = unknown> = {
  ...
  onSuggestionMouseOver: (id: SuggestionId) => void;
  onSuggestionMouseDown: (id: SuggestionId) => void;
};
...
}: SuggestionListArgs<D>): SuggestionList<D> {
